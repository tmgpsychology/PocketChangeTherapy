  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user.role !== "practitioner") {
        setError("This account is registered as a client. Please use the client login.");
        return;
      }
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground">Therapist sign in</h1>
            <p className="text-muted-foreground text-sm mt-1">Welcome back to your practice</p>
          </div>
            ...
            <CardContent className="pt-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={login.isPending}>
                  {login.isPending ? "Signing in..." : "Sign in as Therapist"}
                </Button>
              </form>
              ...
              <div className="mt-5 pt-5 border-t border-border text-center">
                <p className="text-sm text-muted-foreground">
                  ...
                  <Link href="/therapist/register">
                    <span className="text-primary font-medium hover:underline cursor-pointer">Create therapist account</span>
                  </Link>
                </p>
              </div>
            </CardContent>
