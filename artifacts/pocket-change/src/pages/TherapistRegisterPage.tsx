  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register.mutateAsync({
        data: { email, name, password, role: "practitioner", securityQuestion, securityAnswer },
      });
      ...
      <div className="flex-1 flex items-center justify-center p-6 pt-2">
        <div className="w-full max-w-sm">
          <div className="mb-6">
            ...
            <h1 className="text-2xl font-bold text-foreground">Create therapist account</h1>
            <p className="text-muted-foreground text-sm mt-1">Set up your practice on PocketChange</p>
          </div>
            ...
            <CardContent className="pt-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" type="email" placeholder="you@practice.com" value={email} onChange={(e) => setEmail(e.target.value)} required />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="confirm" type="password" placeholder="••••••••" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} autoComplete="new-password" required />
                </div>
                ...
                <Button type="submit" className="w-full" disabled={register.isPending}>
                  {register.isPending ? "Creating account..." : "Create therapist account"}
                </Button>
              </form>
